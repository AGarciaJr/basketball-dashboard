...
export default function BasicsPage(): React.ReactElement {
  return (
    <div className="container mx-auto px-4 py-8">
      <Link href="/learn" className="text-blue-600 hover:text-blue-800 mb-8 inline-block">
        ← Back to Learning Hub
      </Link>
      
      <h1 className="text-4xl font-bold mb-8">Basic Basketball Statistics</h1>
      
      <div className="space-y-8">
        {basicStats.map((stat, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold mb-4">{stat.title}</h2>
